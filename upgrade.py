...
class Item:
    ...
    def display_names(self, surface: Surface, name, cost, selected):
    ...
    def display_bar(self, surface: Surface, value, max_value, selected):
        ...
        value_top = bottom[1] - relative_number
        value_rect = pygame.Rect(top[0] - 15, value_top, 30, 10)
    ...
    def display(self, surface: pygame.Surface, selection_number, name, value, max_value, cost):
