...
class MagicPlayer:
    ...
    def heal(self, player: Player, strength, cost, group: Group):
        if player.energy >= cost:
            ...
            self.animation_player.create_particles('heal', player.rect.center - pygame.math.Vector2(0, 50), group)

    def flame(self, player: Player, cost, groups: Group):
        if player.energy >= cost:
            player.energy -= cost
